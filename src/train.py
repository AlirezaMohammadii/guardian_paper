...
from guardian.utils import (
    get_last_checkpoint_model_id,
    loading_embedding,
    FC_loading_embedding,
    multi_classes_loading_embedding,
)


def main(
    model_ID, epochs, batch_size, validation_split, validation_freq, embedding_folder
):
    # cnn or not
